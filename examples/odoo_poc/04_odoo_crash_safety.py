...
if __name__ == "__main__":
    print("--- Odoo PoC: 04. Crash Containment & Process Isolation ---")
    ...
    try:
        ...
        print(
            f'-> Main process survived! Intercepted expected crash error:\n   "{str(e).splitlines()[0]}"'
        )

    print("✔ Odoo crash-containment demonstration passed.")
